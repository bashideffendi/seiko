...
// ~30 common Seiko calibers with community-sourced production windows.
// Ranges are approximate where the community itself disagrees (rangeConfidence:"approximate").
// This dataset powers BOTH the decoder's decade-narrowing AND the /tools/caliber-lookup page,
// and is the join target for future catalogue data — so the schema is intentionally complete.
...
export const CALIBERS: CaliberDataset = [
  ...
  { caliber: "4r35", aliases: ["4R35A", "4R35B"], startYear: 2011, endYear: null, movementType: "automatic", jewels: 23, family: "5 / Prospex", notes: "Hacking + hand-winding; successor lineage to 7S26.", sources: COMMUNITY },
  { caliber: "4r36", aliases: ["4R36A", "4R36B"], startYear: 2011, endYear: null, movementType: "automatic", jewels: 24, family: "5 Sports / Prospex", longRun: true, notes: "Day-date workhorse in modern Seiko 5 Sports & Prospex.", sources: COMMUNITY },
